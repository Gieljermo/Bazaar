        ...
        @foreach ($calendarData as $day)
            <div class="calendar-day">
                ...
                @elseif(count($day['rentalStart']) > 1)
                    <div class="calendar-item calendar-item-start">
                        <p class="p-1" href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Meerdere producten bekijken...</p>
                    </div>
                    <x-calendar-modal id="exampleModalCenter" title="Ophalen gehuurde producten" :rentData="$day['rentalStart']"></x-calendar-modal>
                @endif
                ...
                @elseif(count($day['rentalEnd']) > 1)
                    ...
                    <x-calendar-modal id="exampleModalCenter" title="Ophalen gehuurde producten" :rentData="$day['rentalEnd']"></x-calendar-modal>
                @endif
                ...
                @elseif(count($day['listingStart']) > 1)
                    ...
                    <x-calendar-modal id="exampleModalCenter" title="Ophalen gehuurde producten" :rentData="$day['listingStart']"></x-calendar-modal>
                @endif
                ...
                @elseif(count($day['listingEnd']) > 1)
                    ...
                    <x-calendar-modal id="exampleModalCenter" title="Ophalen gehuurde producten" :rentData="$day['listingEnd']"></x-calendar-modal>
                @endif
            </div>
        @endforeach
    </div>
